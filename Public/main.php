...
require 'Db/Db-GAE.php';
require 'Models/Group.php';
require 'Models/Member.php';


// https://forum.ionicframework.com/t/how-to-fix-getting-cross-origin-request-blocked/17955/5
// http://stackoverflow.com/questions/18382740/cors-not-working-php
if (isset($_SERVER['HTTP_ORIGIN']) &&
    ($_SERVER['HTTP_ORIGIN'] == 'https://going-dutch.eu' || $_SERVER['HTTP_ORIGIN'] == 'https://going-dutch-eu.appspot.com')) {
